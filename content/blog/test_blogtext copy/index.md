---
title: Introducing Hard Prompts Category in Chatbot Arena2
...
<img src="elo_comparison_1.png"
     alt="elo_comparison_1"
     style="zoom:30%"/>

<center><p>Figure 1. Comparison between Chatbot Arena Category English vs Hard Prompts (English). We set gpt-4-0314 as anchor model.</p></center>
...
<img src="elo_comparison_2.png"
     alt="elo_comparison_2"
     style="zoom:30%"/>

<center><p>Figure 2. Comparison between Chatbot Arena Category English vs Hard Prompts (English). We set mixtral-8x7b-instruct-v0.1 as anchor model.</p></center>
...
<img src="key_criteria_breakdown.png"
     alt="key_criteria_breakdown"
     style="zoom:30%"/>

<center><p>Figure 3. The percentage of each criteria within 1 million Chatbot Arena data.</p></center>

We then calculate its Hardness Score by how many criteria are satisfied and present the distribution in Figure 3. Interestingly, we find that approximately 20% of prompts have a score of 6 or higher. You can find several examples below to demonstrate what a hard prompt looks like in the [Example](#example) Section.


<img src="hardness_breakdown.png"
     alt="hardness_breakdown"
     style="zoom:30%"/>

<center><p>Figure 4. The percentage of prompts with different hardness score within 1 million Chatbot Arena data.</p></center>
...
<center><p>Figure 5. The leaderboard for Hard Prompts (English) category as of May 17, 2024.</p></center>
...
Solve the integral {{< math >}} $\int_{-\infty}^{+\infty} exp(-x^2) dx${{<  /math >}} step-by-step with detailed explanation
